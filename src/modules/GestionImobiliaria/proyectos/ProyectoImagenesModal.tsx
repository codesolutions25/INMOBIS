...
import ProyectoImageUpload from './ProyectoImageUpload';
import ProyectoImagenesList from './ProyectoImagenesList';
import { Upload, List } from "lucide-react";
import styles from './styles/ProyectoImagenesModal.module.css';

interface ProyectoImagenesModalProps {
  proyecto: Proyecto;
...
export default function ProyectoImagenesModal({ proyecto, trigger, onSuccess, closeModal }: ProyectoImagenesModalProps) {
      ...
      <DialogContent className={styles.dialogContent}>
        ...
        <div className={styles.header}>
          <h2 className={styles.tittle}>
            Gestión de imágenes: {proyecto.nombre}
          </h2>
