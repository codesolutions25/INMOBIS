...
export default function CaracteristicasInmobiliariosForm({ 
   ...
   useEffect(() => {
    ...
    // This function will be called by the form with the form data
    const handleSubmit = async (formData: CaracteristicasInmobiliariosFormValues) => {
    ...
    return (
        <DialogContent className={styles.dialogContent}>
            <EntityForm<CaracteristicasInmobiliariosFormValues>
